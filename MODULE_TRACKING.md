...
- **Latest Release**: v0.1.0 (pending merge - https://github.com/nathlan/terraform-azurerm-firewall/pull/1)
- **Features**:
  ...
  - Automated release workflow with initial version 0.1.0 (corrected configuration)
  - Complete terraform-docs generated documentation
