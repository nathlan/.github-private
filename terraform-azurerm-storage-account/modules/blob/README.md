...
Terraform submodule for Azure Storage Account optimized for Blob Storage with secure defaults and region restrictions.

This is an opinionated submodule of [terraform-azurerm-storage-account](../..) that provides secure defaults specifically for blob storage use cases.
...
This submodule implements security best practices by default:
...
- **Region Restriction**: Only australiaeast and australiasoutheast allowed
